...
def the_final_boss():
    ...
    if Attacks and Moves and not Werewolfattacks:
        ...
        if Minotaurgooddistancey and Minotaurgooddistancex:
            ...
            if ran_num == 1:
                if Chainmailhelmet:
                    print("The minotaur hit your head, but your helmet blocked some of the damage and did only "
                          "1 heart.")
                    health = health - 1
                    Minotaurattacks = True
                    the_final_boss()
                else:
                    print("The minotaur hit your head your head and did 2 hearts of damage.")
                    health = health - 2
                    Minotaurattacks = True
                    the_final_boss()
            if ran_num == 2:
                if Chainmailchestplate:
                    print("The minotaur hit your chest, but your chestplate blocked some of the damage and did only "
                          "1 heart.")
                    health = health - 1
                    Minotaurattacks = True
                    the_final_boss()
                else:
                    print("The minotaur hit your head your chest and did 2 hearts of damage.")
                    health = health - 2
                    Minotaurattacks = True
                    the_final_boss()
            if ran_num == 3:
            ...
            if ran_num == 4:
                if Chainmailboots:
                    print("The minotaur hit your head, but your boots blocked some of the damage and did only "
                          "1 heart.")
                    health = health - 1
                    ran_num1 = random.randint(1, 2)
                    Minotaurattacks = True
            ...
            if weapon123 == "Basic Bow":
                if BasicBow:
                    ...
                    if x123-1 == Minotaurx or x123+1 == Minotaurx or y123-1 == Minotaury or y123+1 == Minotaury or \
                            ...
                            x123-3 == Minotaurx or x123+3 == Minotaurx or y123-3 == Minotaury or y123+3 == Minotaury:
                        ran_num = random.randint(1, 5)
                        if ran_num == 1:
            ...
            if weapon123 == "Basic Sword":
                if BasicSword:
                    if Swordturns == 0:
                        ...
                        print("You have to wait " + Swordturns + " turns until you can use your sword.")
                else:
                    print("You don't have a Basic Sword.")
                    the_final_boss()
            if weapon123 == "Basic Axe":
                if BasicAxe:
                    if Axeturns == 0:
                        if x123-1 == Minotaurx or x123+1 == Minotaurx or y123-1 == Minotaury or y123+1 == Minotaury:
                            ran_num = random.randint(1, 5)
                            if ran_num == 1:
                                print("You hit the minotaur in the chest dealing 5 damage and an extra 1 damage "
                                      "because it's his chest.")
                                Minotaur_Health = Minotaur_Health - 6
                                Attacks = True
                                the_final_boss()
                            if ran_num == 2:
                        ...
                        print("You have to wait " + Axeturns + " turns until you can use your axe.")
                else:
                    print("You don't have a Basic Axe.")
                    the_final_boss()
            if weapon123 == "Basic Bow":
                if BasicBow:
                    if Bowturns == 0:
                        if x123-1 == Minotaurx or x123+1 == Minotaurx or y123-1 == Minotaury or y123+1 == Minotaury or \
                                123-2 == Minotaurx or x123+2 == Minotaurx or y123-2 == Minotaury or \
                                y123+2 == Minotaury or x123-3 == Minotaurx or x123+3 == Minotaurx or \
                                y123-3 == Minotaury or y123+3 == Minotaury:
                            ran_num = random.randint(1, 5)
                            if ran_num == 1:
                                print("You hit the minotaur in the chest dealing 2 damage and an extra 1 damage because"
                                      " it's his chest.")
                        ...
                        print("You have to wait " + Bowturns + " turns until you can use your bow.")
                else:
                    print("You don't have a Basic Bow.")
                    the_final_boss()
            if weapon123 == "basic sword":
...
def thefirstfight():
    ...
    if firstimefight == 1:
        print("Suddenly the minotaur starts moving again, but you move out of the way so that it doesn't hit you. It is"
              " your turn. You can type map to see where the minotaur is.")
    ...
    if Attacks and Moves and not Werewolf_Ground and not Werewolfmoves:
        minotaurdistancex = Werewolfx - x123
        minotaurdistancey = Werewolfy - y123
        if minotaurdistancey > 0:
        ...
        if Werewolfgooddistancey and Werewolfgooddistancex:
            ...
            if ran_num == 1:
                if Chainmailhelmet:
                    ...
                    print("The minotaur hit your head and did 2 hearts of damage.")
                    health = health - 2
                    Werewolfattacks = True
                    thefirstfight()
            if ran_num == 2:
            ...
            if ran_num == 3:
                if Chainmailleggings:
                    print("The minotaur hit your legs, but your leggings blocked some of the damage and did only "
                          "1 heart.")
                    health = health - 1
                    Werewolfattacks = True
                    ran_num1 = random.randint(1, 2)
            ...
            if ran_num == 4:
                if Chainmailboots:
                    ...
                    print("The minotaur hit your feet and did 2 hearts of damage. ")
                    health = health - 2
                    Werewolfattacks = True
                    thefirstfight()
        else:
        ...
        if weapon123 == "Basic Sword":
            if BasicSword:
                if x123-1 == Werewolfx or x123+1 == Werewolfx or y123-1 == Werewolfy or y123+1 == Werewolfy:
                    ran_num = random.randint(1, 5)
                    if ran_num == 1:
                        print("You hit the minotaur in the chest dealing 3 damage.")
        ...
        if weapon123 == "Basic Axe":
            if BasicAxe:
                if x123-1 == Werewolfx or x123+1 == Werewolfx or y123-1 == Werewolfy or y123+1 == Werewolfy:
                    ran_num = random.randint(1, 5)
                    if ran_num == 1:
                        print("You hit the minotaur in the chest dealing 5 damage.")
    ...
    if Werewolf_Health == 0:
        print("Narrator: Congratulations, you defeated the minotaur now time to get back to the adventure.")
...
def the_realadventure():
    ...
    if Day == 3 and not Completefirstfight and not DayMessage:
        print("Before you able to go to sleep on the night of day 2 you look at the moon and see it is a full moon that"
              " night, then you hear a low growling sound and from seemingly out of nowhere a minotaur jumps out at "
...
def the_chief():
    ...
    if chieftimes == 1:
        print("Hello, traveler welcome to my village where you can buy equipment for your adventures there is a "
              ...
              "but since you don't seem to have any I will give you 400 points to start with. \nYou can come back "
    ...
    if main == "Shop":
        ...
        if item == "all":
            if bal >= 160:
                ...
                Chainmailboots = True
                Chainmailhelmet = True
                print("You bought all of the armor!")
                the_blacksmith()
            else:
    ...
    if main == "shop":
        ...
        if item == "Chainmail Helmet":
            if not Chainmailhelmet:
                if bal >= 40:
                    bal = bal-40
                    Chainmailhelmet = True
                    print("You now have chainmail helmet.")
                    the_armorsmith()
                else:
                    print("You don't have enough points")
                    the_armorsmith()
        ...
        if item == "Chainmail Chestplate":
            if not Chainmailchestplate:
                if bal >= 40:
                    bal = bal - 40
                    Chainmailchestplate = True
                    print("You now have chainmail chestplate.")
                    the_armorsmith()
                else:
                    print("You don't have enough points")
                    the_armorsmith()
        ...
        if item == "chainmail chestplate":
            if not Chainmailchestplate:
                ...
                the_armorsmith()
        if item == "Chainmail Leggings":
            if not Chainmailleggings:
                if bal >= 40:
                    bal = bal - 40
                    Chainmailleggings = True
                    print("You now have chainmail leggings.")
                    the_armorsmith()
                else:
                    print("You don't have enough points")
                    the_armorsmith()
        ...
        if item == "chainmail boots":
            if not Chainmailboots:
                if bal >= 40:
                    bal = bal - 40
                    Chainmailboots = True
                    print("You now have chainmail boots.")
                    the_armorsmith()
                else:
                    print("You don't have enough points")
                    the_armorsmith()
